...
if __name__ == '__main__':
    ...
    with open(input_filename, 'r', encoding='utf-8') as f, open(output_filename, 'w', encoding='utf-8') as g:
        ...
        for idx, line in enumerate(tqdm(f)):
            ...
            if len(sentence):
                ...
                print(f"valid_triplets {valid_triplets}")
                if len(valid_triplets) > 0:
                    ...
                    for triplet in valid_triplets:
                        ...
                        mapped_triplet = {'h': head, 't': tail, 'r': '_'.join(relations)}
                ...
                output = {'line': idx, 'tri': mapped_triplets}
                if include_sentence:
